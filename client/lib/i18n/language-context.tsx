...
const DICTIONARY: Record<Language, Record<string, string>> = {
  en: {
    ...
    "wizard.step_2": "Spatial Program",
    "wizard.step_3": "Style Discovery",
  ...
  ar: {
    ...
    "wizard.step_2": "الفراغات المعمارية",
    "wizard.step_3": "استكشاف الطراز",
    ...
    "wizard.step_11": "الملخص والاعتماد",
    ...
    "lifecycle.step_review": "الملخص والاعتماد",
    "nav.fitout_commission": "تكليف التشطيبات المعمارية • مسار المواصفات",

    // Style Strategy & Multi-Mode
    "style_strategy.title": "استراتيجية الطراز المعماري",
    "style_strategy.subtitle": "اختر أسلوبك المفضل في تحديد الطراز الداخلي لفراغات مسكنك.",
    "style_strategy.unified_title": "ستايل واحد للكل",
    "style_strategy.unified_desc": "طراز وتناغم بصري موحد يسري بسلاسة عبر جميع فراغات وغرف المسكن.",
    "style_strategy.per_space_title": "ستايل لكل فراغ",
    "style_strategy.per_space_desc": "تخصيص طراز ومواد مستقلة لكل غرفة أو جناح حسب طبيعة استخدامه.",
    "style_strategy.designer_title": "دع المصمم يحدد الطراز",
    "style_strategy.designer_desc": "يتولى كبار مصممي الأتيليه اختيار الطراز الأنسب لضوء وتوجيه المبنى.",
    "style_gallery.title": "معرض الطراز المعماري",
    "style_gallery.view_btn": "استعراض تفاصيل وغرف الطراز",
    "style_gallery.confirm_unified": "تأكيد واعتماد هذا الطراز لكامل المشروع",
    "style_gallery.confirm_per_space": "تطبيق الطراز على الفراغات المحددة",
    "style_gallery.select_spaces_label": "اختر الفراغات التي ترغب بتطبيق هذا الطراز عليها:",
    "style_gallery.select_all": "تحديد الكل",
    "style_gallery.clear_all": "إلغاء التحديد",
    "style_gallery.applied_spaces": "مطبق على",
    "style_gallery.no_spaces_selected": "يرجى تحديد فراغ واحد على الأقل",
    "brief.title": "ملخص رؤيتك المعمارية",
    "brief.eyebrow": "٠٥ — ٠٦ • ملخص التكليف والتصميم",
    "brief.subtitle": "موجز شامل لاختياراتك المعمارية والمكانية. يمكنك تعديل أي قسم قبل الاعتماد.",
    "brief.edit_selections": "تعديل الاختيارات",
    "brief.property_type": "نوع العقار",
    "brief.primary_style": "الطراز الأساسي",
    "brief.per_space_styles": "توزيع الطرز على الفراغات",
    "brief.included_spaces": "الفراغات المشمولة",
    "brief.inspiration_gallery": "معرض الإلهام والمواد",
