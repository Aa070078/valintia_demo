...
export function StepTimeline({ timeline, onChangeTimeline }: StepTimelineProps) {
  ...
  return (
    <div className="flex flex-col gap-8 animate-in fade-in duration-300">
      ...
      {timeline.deadlineType === "duration" && (
        <div className="p-5 rounded-2xl bg-[#FAF7F2] dark:bg-[#1E1B18] border border-[#E6DDD2] dark:border-[#2E2A27] flex flex-col gap-3 animate-in fade-in duration-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
            {DURATIONS.map((dur) => (
              <button
                ...
                className={cn(
                  "p-3 rounded-xl border text-start text-xs font-medium transition-all",
      ...
      {timeline.deadlineType === "specific_date" && (
        <div className="p-5 rounded-2xl bg-[#FAF7F2] dark:bg-[#1E1B18] border border-[#E6DDD2] dark:border-[#2E2A27] flex flex-col gap-2 max-w-sm animate-in fade-in duration-300">
          <label className="text-xs font-semibold text-[#503C2C] dark:text-[#D4C3B3]">
